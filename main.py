...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str,
                        default="results/models_test_210126/")
    parser.add_argument("--model_name", type=str, default="model.pth")

    # Device setup
    parser.add_argument("--device_ids", type=list, default=[0,]) #[2, 3])
    ...
    parser.add_argument("--l1_weight", type=float, default=0.5)  # L1 loss funtion weight
    ...
    parser.add_argument("--phase", type=str, default="train")  # Phase - train or test or no_mask
    ...
    parser.add_argument("--patch_size", type=tuple, default=(256, 256))  # Patch size for data augmentation

    parser.add_argument("--batch_size", type=int, default=40)  # Batch size for mini-batch stochastic gradient descent
    ...
    parser.add_argument("--lr_opt", type=dict, default={"policy": "plateau",
                                                        ...
                                                        "term": 1e-8,  # Terminating learning rate condition
